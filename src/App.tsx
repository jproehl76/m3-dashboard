    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans">
      <header className="border-b border-slate-800 sticky top-0 z-10 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url('/m3-track.jpg')',
      ...
      <div className="flex" style={{ height: 'calc(100vh - 57px)' }}>
        {sidebarOpen && (
          ...
          <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-32" style={{backgroundImage:"url('/m3-track.jpg')",backgroundSize:"cover",backgroundPosition:"center 50%",opacity:0.07,maskImage:"linear-gradient(to bottom, transparent, black)",WebkitMaskImage:"linear-gradient(to bottom, transparent, black)"}} />
